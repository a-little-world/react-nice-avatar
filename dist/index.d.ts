...
export type HairStyle = 'normal' | 'buzz' | 'bald' | 'thick' | 'mohawk' | 'womanLong' | 'womanShort'
export type HairStyleMan = 'normal' | 'buzz' | 'bald' | 'thick' | 'mohawk'
export type HairStyleWoman = 'normal' | 'buzz' | 'womanLong' | 'womanShort'
